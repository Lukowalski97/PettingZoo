...
class parallel_env(ParallelEnv):
    ...
    def step(self, actions):
        ...
        for sensor_id, sensor in self.env.get_sensors():
            ...
            observation = {'all_coverage': all_coverage, 'sensor_coverage': sensor_coverage,
                           'other_coverage': other_coverage}

            rewards[sensor_id] = reward
            dones[sensor_id] = False  # TODO find requirement to finish
            infos[sensor_id] = None  # TODO do we need any?
...
def example_1():
    ...
    rend_env.render_environment(25, 25, sensing_env.get_coverage_by_other_sensors_area(sensor0))
